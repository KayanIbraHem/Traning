...
return [
    ...
    'last_name_min' => "حقل الاسم الاخير يجب الا يقل عن 4 حروف",
    'last_name_max' => "حقل الاسم الاخير يجب الا يزيد عن 255 حروف",
    ...
    'email_invalid' => "يرجى كتابة البريد الالكتروني بشكل صحيح",
    'email_unique' => "البريد الالكتروني مستخدم بالفعل",
    //GENERAL.PASSWORD
